...
c.execute("INSERT INTO cities (like_messi, save_messi, nome, paese, photo, description, iata) VALUES (0, 0, 'Terni', 'Italy', 'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEj4HJyXBPmRE6T9ImicfDZsCh7oj6pEfxmTvujW_CEgmC1BrVMXH-v_i8um_vAqB2uudV8EMrZOidPbml5XJ-zwZY0w52R0lUJE7ER0GGm0CA3qcLNrn0tk_n9_YMnHIuSXMMdugCTYK9yn/s2048/IMG_20200919_145750.jpg', 'Enjoy the picturesque views of Piediluco Lake and the medieval Rocca Albornoziana.', 'PEG')")
...
c.execute("INSERT INTO cities (like_messi, save_messi, nome, paese, photo, description, iata) VALUES (0, 0, 'New York City', 'USA', 'https://media.tacdn.com/media/attractions-splice-spp-674x446/07/bd/6f/17.jpg', 'New York City is known for its iconic skyline, Broadway shows, and diverse culture.', 'JFK')")
c.execute("INSERT INTO cities (like_messi, save_messi, nome, paese, photo, description, iata) VALUES (0, 0, 'New York City', 'USA', 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/New_york_times_square-terabass.jpg/1200px-New_york_times_square-terabass.jpg', 'Experience the energy of Times Square in the heart of New York City.', 'JFK')")
c.execute("INSERT INTO cities (like_messi, save_messi, nome, paese, photo, description, iata) VALUES (0, 0, 'New York City', 'USA', 'https://mywowo.net/media/images/cache/new_york_central_park_02_parte_sett_centrale_jpg_1200_630_cover_85.jpg', 'Relax and unwind in the natural beauty of Central Park in New York City.', 'JFK')")
c.execute("INSERT INTO cities (like_messi, save_messi, nome, paese, photo, description, iata) VALUES (0, 0, 'New York City', 'USA', 'https://imgcap.capturetheatlas.com/wp-content/uploads/2022/01/little-island-free-things-nyc.jpg', 'Visit Little Island, a unique park and cultural space on the Hudson River.', 'JFK')")
c.execute("INSERT INTO cities (like_messi, save_messi, nome, paese, photo, description, iata) VALUES (0, 0, 'New York City', 'USA', 'https://assets3.thrillist.com/v1/image/2680204/1200x630/flatten;crop_down;webp=auto;jpeg_quality=70', 'Discover hidden gems and off-the-beaten-path attractions in New York City.', 'JFK')")
...
# Inserimento dei dati per Oslo
c.execute("INSERT INTO cities (like_messi, save_messi, nome, paese, photo, description, iata) VALUES (0, 0, 'Oslo', 'Norway', 'https://image.jimcdn.com/app/cms/image/transf/dimension=1920x1024:format=jpg/path/sd05c52ea747ad2d6/image/i4ce6b5559a479a4f/version/1666287559/oslo-city-center-norvegia.jpg', 'Oslo is the capital city of Norway, known for its scenic fjords, museums, and outdoor activities.', 'OSL')")
c.execute("INSERT INTO cities (like_messi, save_messi, nome, paese, photo, description, iata) VALUES (0, 0, 'Oslo', 'Norway', 'https://static2-viaggi.corriereobjects.it/wp-content/uploads/2015/06/oslo-wikipedia-1080x719.jpg?v=1572448800', 'Explore the vibrant city center of Oslo with its modern architecture and bustling streets.', 'OSL')")
c.execute("INSERT INTO cities (like_messi, save_messi, nome, paese, photo, description, iata) VALUES (0, 0, 'Oslo', 'Norway', 'https://moveo.telepass.com/wp-content/uploads/2023/10/oslo-munch-museum.jpeg', 'Admire the natural beauty of Oslo''s surroundings, including forests and lakes.', 'OSL')")
c.execute("INSERT INTO cities (like_messi, save_messi, nome, paese, photo, description, iata) VALUES (0, 0, 'Oslo', 'Norway', 'https://miro.medium.com/v2/resize:fit:1400/0*uzryjySGRMRPuCTh', 'Discover the rich cultural heritage of Oslo through its art galleries and historic sites.', 'OSL')")
